...
import (
	...
	webappv1 "karthikn23/testOperator/api/v1"
)
...
//+kubebuilder:rbac:groups=webapp.beezlabs.com,resources=testoperators,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=webapp.beezlabs.com,resources=testoperators/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=webapp.beezlabs.com,resources=testoperators/finalizers,verbs=update
